...
## 개요
- 1인 가구의 증가와 함께 반려동물 시장 규모가 확장되고 있음
- 이러한 트렌드를 바탕으로 펫 시터 및 산책 메이트를 매칭해주는 반려동물 서비스를 개발
- 프로젝트의 목표는 반려동물 커뮤니티와 버티컬 커머스까지 확장하여 상용화에 이르는 것
...
- 기술적인 목표는 아래와 같음
  ...
  - 커뮤니티, 커머스 기능과 함께 MSA 환경으로 통합 구축하여 확장 가능한 서비스화
